...
namespace GwentWebAssembly.Services
{
    public class LobbySetupService : ILobbySetupService
    {
        ...
        public async Task SendLobbyReady() => await _gwentHubService.SendLobbyReady(_playerService.LobbyCode);

        public async Task CardsSelected() => await _gwentHubService.SendCardsSelected(_playerService.LobbyCode);
    }
}
